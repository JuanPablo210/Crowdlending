...
export class RestService {
  ...
  index<T>(_params?: { [key: string]: any; }, _controller?: string, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    let action = '';
    if (_params !== undefined) { opts['params'] = _params; }
    if (_action !== undefined && _action !== '') { action = _action; }
  ...
  create<T>(_params?: { [key: string]: any; }, _controller?: string, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    let action = 'create';
    if (_params !== undefined) { opts['params'] = _params; }
    if (_action !== undefined && _action !== '') { action = _action; }
  ...
  edit<T>(_id, _params?: { [key: string]: any; }, _controller?: string, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    let action = 'edit';
    if (_params !== undefined) { opts['params'] = _params; }
    if (_action !== undefined && _action !== '') { action = _action; }
  ...
  update<T>(_id, _data: { [key: string]: any; }, _params?: { [key: string]: any; }, _controller?: string, _action?: string) {
    const opts = this.globalService.getHttpOptions();
    const data = _data;
    let action = 'update';
    if (_params !== undefined) { opts['params'] = _params; }
