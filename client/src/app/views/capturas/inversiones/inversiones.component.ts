...
import {DivisaFormComponent} from "../../catalogos/divisa/divisa-form/divisa-form.component";
import {DivisaDeleteComponent} from "../../catalogos/divisa/divisa-delete/divisa-delete.component";
...
export class InversionesComponent implements OnInit {
  public _datos = { _title: 'Divisa', _modulo: 'Catálogos', _icono: 'fas fa-folder-open', _dominio: 'Divisa', _componente: 'Divisa'}
