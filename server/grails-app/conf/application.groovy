...
grails.plugin.springsecurity.password.algorithm='bcrypt'// Added by the Spring Security Core plugin:
...
grails.plugin.springsecurity.interceptUrlMap = [
		...
		[pattern: '/preusuario/**', access: ['permitAll']],
...
grails.plugin.springsecurity.filterChain.chainMap = [
		...
		[pattern: '/preusuario/**', filters: 'none'],
		[pattern: '/proceso_solicitud_cuenta/**', filters: 'none'],
...
style.name='Crowdlending'
logo.name='Crowdlending'
logo.ext='png'
