        ...
        if (e) {
            if (e instanceof AccountExpiredException) {
                ...
                msg = messageSource.getMessage("springSecurity.errors.login.tokenNotFound", null, "La sesión ha expirado", request.locale)
                    ...
                    msg = messageSource.getMessage('springSecurity.errors.login.max.sessions.exceeded', null, "Lo sentimos, usted ha excedido el numero de sesiones.", request.locale)
            }else {
